...
def create_form_opts():
    ...
    test_images.loc[:,'img_name'] = test_images.loc[:,'id'].apply(lambda x: '%05d.jpg'%x)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--lambda_function_name", type=str,
        default="serve-cv-object-counter"
    )    
    parser.add_argument(
        "--s3_bucket", type=str, 
        default="amazon-bin-images-sub"
    )
    parser.add_argument(
        "--s3_prefix", type=str, 
        default=""
